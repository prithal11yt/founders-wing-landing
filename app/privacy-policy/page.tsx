  ...
  return (
    <div className="flex flex-col min-h-screen bg-white text-neutral-950">
      ...
      <main className="flex-1 w-full mx-auto px-5 pt-36 md:pt-44 pb-20 max-w-3xl">
        <h1 className="text-4xl md:text-5xl font-medium tracking-[-0.04em] mb-3">Privacy Policy</h1>
        ...
        <section className="space-y-6 text-neutral-600 leading-relaxed">
          ...
          <div>
            <h2 className="text-xl font-medium text-neutral-900 mb-2">1. Who We Are</h2>
            <p>
              Founders Wing (&quot;we&quot;, &quot;us&quot;, or &quot;our&quot;) is an AI-first founder community operated by Prithal Bhardwaj.
              You can reach us at <a href="mailto:prithalbhardwaj@gmail.com" className="text-sky-700 hover:underline">prithalbhardwaj@gmail.com</a>.
            </p>
          </div>

          <div>
            <h2 className="text-xl font-medium text-neutral-900 mb-2">2. Information We Collect</h2>
          ...
          <div>
            <h2 className="text-xl font-medium text-neutral-900 mb-2">3. How We Use Your Information</h2>
          ...
          <div>
            <h2 className="text-xl font-medium text-neutral-900 mb-2">4. Data Storage and Security</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-medium text-neutral-900 mb-2">5. Cookies</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-medium text-neutral-900 mb-2">6. Third-Party Services</h2>
          ...
          <div>
            <h2 className="text-xl font-medium text-neutral-900 mb-2">7. Your Rights</h2>
            ...
            <p className="mt-2">
              To exercise any of these rights, email us at <a href="mailto:prithalbhardwaj@gmail.com" className="text-sky-700 hover:underline">prithalbhardwaj@gmail.com</a>.
            </p>
          </div>

          <div>
            <h2 className="text-xl font-medium text-neutral-900 mb-2">8. Children&apos;s Privacy</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-medium text-neutral-900 mb-2">9. Changes to This Policy</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-medium text-neutral-900 mb-2">10. Contact</h2>
            <p>
