  ...
  return (
    <ScrollReveal variant="fade-up" duration={800}>
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 py-8 px-8 neu-flat rounded-2xl">
          <p className="text-lg font-semibold text-foreground text-center sm:text-left">{text}</p>
          <Button
            size="lg"
